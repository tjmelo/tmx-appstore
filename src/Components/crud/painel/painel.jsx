...
export const Painel = () => {
    ...
    const save = e => {
        ...
        let inputsVal = document.querySelectorAll(`.inpt`), valid = false;
                ...
                <div className={painel.form}>
                    ...
                    <div className={painel.input}>
                        ...
                        <input 
                            ...
                            defaultValue={product.size && (product.size).join(',')}
                            />
                    </div>
                    ...
                    <div className={painel.input}>
                        ...
                        <select name="imagem" id="imagem">
                            <option selected={product.image && product.image === "/shoes/shoe.jpg"} value="/shoes/shoe.jpg">Imagem de um tênis</option>
                            <option selected={product.image && product.image === "/socks/sock.jpg"} value="/socks/sock.jpg">Imagem de uma meia</option>
                        </select>
                    </div>
                    ...
                    <div className={painel.input}>
                        ...
                        <div className={painel.options}>
                            <input name="product" defaultChecked={product.type && product.type === 'Tênis'} type="radio" id="shoes" value="Tênis"/>
                            <label htmlFor="shoes">Tênis</label>
                        </div>
                        <div className={painel.options}>
                            <input name="product" defaultChecked={product.type && product.type === 'Meia'} type="radio" id="socks" value="Meia"/>
                    ...
                    <div className={painel.input}>
                        ...
                        <div className={painel.options}>
                            <input name="category" type="radio" defaultChecked={product.category && product.category === 'Masculino'} id="maculino" value="Masculino"/>
                            <label htmlFor="maculino">Masculino</label>
                        </div>
                        <div className={painel.options}>
                            <input name="category" type="radio" defaultChecked={product.category && product.category === 'Feminino'} id="feminino" value="Feminino"/>
                            <label htmlFor="feminino">Feminino</label>
                        </div>
                        <div className={painel.options}>
                            <input name="category" type="radio" defaultChecked={product.category && product.category === 'Unissex'} id="unissex" value="Unissex"/>
                    ...
                    <div className={painel.textarea}>
                        <div className={painel.input}>
                            ...
                            <div className={painel.options}>
                                <input name="promo" defaultChecked={product.promo && product.promo === '0'} type="radio" id="promo0" value="0"/>
                                <label htmlFor="promo1">Sem desconto</label>
                            </div>
                            <div className={painel.options}>
                                <input name="promo" defaultChecked={product.promo && product.promo === '1'} type="radio" id="promo1" value="1"/>
                                <label htmlFor="promo1">Desconto do tipo 1</label>
                            </div>
                            <div className={painel.options}>
                                <input name="promo" defaultChecked={product.promo && product.promo === '2'} type="radio" id="promo2" value="2"/>
                                <label htmlFor="promo2">Desconto do tipo 2</label>
                            </div>
                        </div>
                        ...
                        <input 
                            ...
                            defaultValue={product.promotion && product.promotion}/>

                    </div>
                </div>
                
                <button onClick={save} value="Salvar" className={painel.button}>Salvar</button>
            </form>
        </section>
    )
}